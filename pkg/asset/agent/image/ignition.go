...
func (a *Ignition) Generate(dependencies asset.Parents) error {
	...
	err = addBootstrapScripts(&config, agentManifests.ClusterImageSet)
	if err != nil {
		return err
	}
...
func addBootstrapScripts(config *igntypes.Config, clusterImageSet *hivev1.ClusterImageSet) (err error) {
